...
\
Install **Python 2.x** by first adding this repository: (Type these instructions into your terminal)\
\
...
\
You should now have successfully compiled and built Mitsuba 0.6.0. The binaries can be located in the "dist" directory that is created after a successfull compile.
